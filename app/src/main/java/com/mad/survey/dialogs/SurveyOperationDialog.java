...
public class SurveyOperationDialog extends Dialog {
	...
	public SurveyOperationDialog(final Context context, ProjectData project, View.OnClickListener listener) {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dlg_existing_survey_operations);
        ...
        findViewById(R.id.btnSubmit).setOnClickListener(mClickListener);
