...
public class SurveyExitDialog extends Dialog {
	...
	public SurveyExitDialog(final Context context, ProjectData project, View.OnClickListener listener) {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dlg_survey_exit);
