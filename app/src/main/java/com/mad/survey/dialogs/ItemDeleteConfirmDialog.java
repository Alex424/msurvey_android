...
public class ItemDeleteConfirmDialog extends Dialog {
	...
	public ItemDeleteConfirmDialog(final Context context, String bankInfo,String floorInfo,String itemDesc, View.OnClickListener listener) {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dlg_existing_item_delete_confirm);
